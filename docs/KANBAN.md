...
- [x] FEAT-002: Global Hotkey
- [x] FEAT-018: UX Verbesserungen (Excel öffnen, Bearbeiten im Chat)
...
- [x] FEAT-017: Windows Installer (.exe)
- [x] FEAT-014: Rückfragen bei fehlenden Feldern (Voice)
